// array
let names = ["ali", "veli", "can"];

let years = [2000, 2001, 2002, 2006];

let mix = ["ali", 2000, "veli", null, undefined, ["araştırma", "kodlama"]];
...
//includes
console.log(mix.includes("can")); // can elemanı mıdır true evet elemandır
...
// sıralama zamanı sadece en baştaki haneye bakarak küçükten büyüğe sıralar bu sorun ortadan kaldıralım 
